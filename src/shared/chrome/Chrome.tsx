...
// the default for `npm run dev`/`preview`), embed it for a pixel-exact 1:1 background.
// Otherwise fall back to the in-repo WebGL reimplementation (HeroBackground).
const useEmbeddedEngine = Boolean(import.meta.env.VITE_ENGINE_URL);
